...
timestamps = np.loadtxt(fileName, skiprows = 2, delimiter = ', ', usecols = tuple(timestampSpacer[:-1])) / 1000000
data = (np.loadtxt(fileName, skiprows = 2, delimiter = ', ', usecols = tuple(dataSpacer)) - memsicCenterOffset) * memsicFullScale / memsicMSB * gauss2MilliTesla
...
fullDataOffsetCompensated = (fullDataReset - fullDataSet)/2
